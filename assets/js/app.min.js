...
EpaycoCheckout.require.define({
    ...
    EpaycoCheckout.require.define({"loader/lib/util":function(e,n,a){(function(){var e;e=EpaycoCheckout.require("loader/lib/validators"),a.exports={getUrl:function(){return window.location.origin},getParameterUrl:function(e,n){var a=location.search.slice(1),t={};return a.replace(/([^=]*)=([^&]*)&*/g,(function(e,n,a){t[n]=a})),t},pushParameterUrl:function(e){var n,a,t=[];for(n in e)e.hasOwnProperty(n)&&(a=e[n],t.push(n+"="+a));location.search=t.join("&")},validation:function(n,a=!0){var t=$(".main-steps.active"),r=n||t.data("group"),i=$(".step-"+r),o={};switch(r){case"tdc":o={name:i.find("input[name=name]"),card:i.find("input[name=card-number2]"),cvc:i.find("input[name=cvc]"),expiry:i.find("input[name=expiry]"),valid_franchise:i.find("input[name=valid_franchise]"),dues:i.find("select[name=dues-tdc]"),remember:i.find("input[name=remember]")};break;case"tdc-info":o={type:i.find("select[name=type]"),number:i.find("input[name=number]"),telephone:i.find("input[name=telephone]"),country:i.find("select[name=country]"),city:i.find("input[name=city]"),address:i.find("input[name=address]"),terms:i.find("input[name=terms]"),privacy:i.find("input[name=privacy]")}}var u=!0,c=e.iterator(o);for(var p in null!=c.find((e=>"number"==e.type))&&(c.find((e=>"number"==e.type)).isValid=validateTypeDoc(c)),c)c[p].isValid||(u=!1);return{status:u,data:c}},createGuid:function(){function e(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e()},createTokenEncrypt:function(e,n,a){var t,r="https://api.secure.payco.co/";$.ajax({type:"POST",url:r+"token/encrypt",crossDomain:!0,dataType:"json",data:{public_key:$("#p_c").text(),session:e}}).done((function(e){function i(e,n){if(e&&"undefined"!==n)try{return CryptoJS.AES.encrypt(CryptoJS.enc.Utf8.parse(e),n).toString().toString()}catch(a){return CryptoJS.AES.encrypt(CryptoJS.enc.Utf8.parse(e),CryptoJS.enc.Utf8.parse(n).toString()).toString()}else console.log("hay algunos valores invalidos")}t=e.data.token;var o=JSON.stringify(function(){for(var e=[],a=0;a<n.data.length;a++){if("name"==n.data[a].type&&e.push({type:"name",value:i(n.data[a].value,t)}),"email"==n.data[a].type&&e.push({type:"email",value:i(n.data[a].value,t)}),"card"==n.data[a].type){let r=n.data[a].value.replace(/ /g,"");e.push({type:"number",value:i(r,t)})}"cvc"==n.data[a].type&&e.push({type:"cvc",value:i(n.data[a].value,t)}),"expiry"==n.data[a].type&&e.push({type:"date_exp",value:i(n.data[a].value,t)})}var r={type:"publicKey",value:$("#p_c").text()},o={type:"session",value:localStorage.getItem("keyUserIndex")};return e.push(r),e.push(o),e}());$.ajax({type:"POST",url:r+"token/tokenize",crossDomain:!0,dataType:"json",data:{values:o}}).done((function(e){(e.data.status="created")?a(e.data.token,null):a(null,e.data)})).fail((function(e){a(null,e)}))})).fail((function(e){a(null,e)}))},validFranchise:function(e,n,a){$.post("/fanch",[{name:"type",value:e},{name:"franch",value:n},$("input[name=_id]")[0]],(function(e){a(e)}))},screenErrors:function(e){const n=document.getElementById("the-card-number2-element");for(var a in e)e[1].isValid?n.className="card-number2":n.className="card-number2 error-input",e.hasOwnProperty(a)&&0==e[a].isValid&&("cash"==e[a].type?$(".money-icons").addClass("error-input-ico"):$("[name="+e[a].type+"]").addClass("error-input"))},cleanErrors:function(e){for(var n in e)e.hasOwnProperty(n)&&$("[name="+e[n].type+"]").removeClass("error-input")}}}).call(this)}});
